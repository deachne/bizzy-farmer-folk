...
import { X, ChevronLeft, ChevronRight, Save, Copy, Download, ChevronRight as MinimizeIcon, ChevronLeft as MaximizeIcon } from "lucide-react";
...
const ArtifactPanel = ({ 
  ...
  }, [isOpen, isMinimized, onClose, currentIndex, artifacts.length]);
  ...
  return (
    <>
      ...
      {isMinimized && (
        <div 
          className="fixed right-0 bottom-20 bg-primary text-white p-2 rounded-l-md cursor-pointer z-50 shadow-md animate-slide-in-right"
          onClick={onMaximize}
          aria-label="Maximize"
        >
